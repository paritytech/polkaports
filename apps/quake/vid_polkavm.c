...
POLKAVM_IMPORT_WITH_INDEX(1, void, pvm_set_palette, long)
POLKAVM_IMPORT_WITH_INDEX(2, void, pvm_display, long, long, long)
POLKAVM_IMPORT_WITH_INDEX(3, long, pvm_fetch_inputs, long, long)
POLKAVM_IMPORT_WITH_INDEX(4, long, pvm_init_audio, long, long, long)
POLKAVM_IMPORT_WITH_INDEX(5, long, pvm_output_audio, long, long)
